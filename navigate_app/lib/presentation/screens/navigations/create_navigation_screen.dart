  ...
  Future<void> _performSave({bool silent = false}) async {
    ...
    try {
      ...
      final navigation = domain.Navigation(
        ...
        executionOrder: _hasBoundaryChanged ? null : widget.navigation?.executionOrder,
        routeLengthKm: domain.RouteLengthRange(min: _distanceMin, max: _distanceMax),
        checkpointsPerNavigator: widget.navigation?.checkpointsPerNavigator,
        startPoint: _hasBoundaryChanged ? null : widget.navigation?.startPoint,
        endPoint: _hasBoundaryChanged ? null : widget.navigation?.endPoint,
        waypointSettings: widget.navigation?.waypointSettings ?? const WaypointSettings(),
        scoringCriterion: widget.navigation?.scoringCriterion,
        boundaryLayerIds: _boundaryResult?.sourceBoundaryIds ?? [],
        safetyTime: widget.navigation?.safetyTime,
        ...
        forceComposition: widget.navigation?.forceComposition ?? const ForceComposition(),
        starLearningMinutes: widget.navigation?.starLearningMinutes,
        starNavigatingMinutes: widget.navigation?.starNavigatingMinutes,
        starAutoMode: widget.navigation?.starAutoMode ?? false,
        parachuteSettings: widget.navigation?.parachuteSettings,
        clusterSettings: widget.navigation?.clusterSettings ?? const ClusterSettings(),
        variablesSheet: widget.navigation?.variablesSheet,
        checklistCompletion: widget.navigation?.checklistCompletion,
