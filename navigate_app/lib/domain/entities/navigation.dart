...
class Navigation extends Equatable {
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      // שדות חלוקה — תמיד כוללים (גם null) כדי ש-Firestore merge:true ינקה אותם בשינוי גבול
      'executionOrder': executionOrder,
      'routeLengthKm': routeLengthKm?.toMap(),
      ...
      'parachuteSettings': parachuteSettings?.toMap(),
      'starLearningMinutes': starLearningMinutes,
      'starNavigatingMinutes': starNavigatingMinutes,
      'starAutoMode': starAutoMode,
      'clusterSettings': usesClusters ? clusterSettings.toMap() : null,
